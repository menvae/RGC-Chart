...
nodePackage.name = 'rgc-chart-node';
fs.writeFileSync(nodePackagePath, JSON.stringify(nodePackage, null, 2));
console.log('Node package name updated');
...
webPackage.name = 'rgc-chart-web';
fs.writeFileSync(webPackagePath, JSON.stringify(webPackage, null, 2));
console.log('Web package name updated');

console.log('All package names updated');
